...
class SiembraPlan(Base):
    ...
    ciclo_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("ciclo.ciclo_id", ondelete="RESTRICT"), index=True, nullable=False)
    ...
    created_by: Mapped[int | None] = mapped_column(BigInteger, ForeignKey("usuario.usuario_id", ondelete="RESTRICT"), nullable=True)
...
class SiembraEstanque(Base):
    ...
    siembra_plan_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("siembra_plan.siembra_plan_id", ondelete="CASCADE"), index=True, nullable=False)
    estanque_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("estanque.estanque_id", ondelete="RESTRICT"), index=True, nullable=False)
    ...
    created_by: Mapped[int | None] = mapped_column(BigInteger, ForeignKey("usuario.usuario_id", ondelete="RESTRICT"))
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=False), server_default=func.now(), nullable=False)
    updated_at: Mapped[datetime] = mapped_column(DateTime(timezone=False), server_default=func.now(), onupdate=func.now(), nullable=False)
...
class SiembraFechaLog(Base):
    ...
    siembra_estanque_id: Mapped[int] = mapped_column(BigInteger, ForeignKey("siembra_estanque.siembra_estanque_id", ondelete="CASCADE"), index=True, nullable=False)
    ...
    changed_by: Mapped[int] = mapped_column(BigInteger, ForeignKey("usuario.usuario_id", ondelete="RESTRICT"), nullable=False)
